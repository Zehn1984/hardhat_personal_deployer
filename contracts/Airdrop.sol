...
contract AirdropToken is ERC20, Ownable {
    ...
    function airdropMint() public onlyOwner {
        ...
        for (uint i = 0;i < _addrArr.length; i++) {
            _mint(_addrArr[i], _amount * 10 ** decimals());
        }
    }
}